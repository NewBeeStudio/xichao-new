...
def csrf_protect():
    ...
    if request.method == "POST" and request.path!="/login" and request.path!="/register" and request.path!="/upload/tailor/avatar" and request.path!="/editor/article" and current_user.role!=3:
